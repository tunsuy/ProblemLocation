...
router.get('/', function(req, res, next) {
    ...
    if (global.reqServerIP) {
		res.render('legwork.ejs', { modelsAttributes: modelsAttributesData, modelsPropertys: modelsPropertysData, serverIP: global.reqServerIP, account: "", content: ""});
	}else{
        res.redirect('/');
    }
	// else{
...
router.post('/', function(req, res, next) {
    ...
    reqLgModelFlag = req.body['lgModelFlag'];
        ...
        alyConn.on('ready', function() {
            alyConn.exec(contentCmd, function(err, stream) {
                ...
                stream.on('close', function(err, stream) {
                    ...
                    alyConn.on('ready', function() {
                        ...
                        alyConn.exec(contentCmd, function(err, stream) {
                            ...
                            stream.on('close', function(err, stream) {
                                ...
                                contentData += "\n";
                                contentData += data;
                                res.render('legwork.ejs', { modelsAttributes: modelsAttributesData, modelsPropertys: modelsPropertysData, serverIP: global.reqServerIP, account: reqAccount, content: contentData});
                                return;
                    ...
                    lgModelFlag = (reqLgModelFlag == "on")?1:0;
                    ...
                    contentCmd = "python legwork.py "+did+" "+lgModelFlag;
